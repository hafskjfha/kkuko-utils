                        ...
                        currentRequests.map((req) => {
                            ...
                            return (
                                <TableRow key={req.id} className={isMyRequest ? "bg-gray-50" : ""}>
                                    ...
                                    <TableCell className={req.requested_by ? "text-blue-600 underline hover:cursor-pointer" : ""} onClick={() => { req.requested_by && router.push(`/profile?username=${req.requested_by.nickname}`) }}>
