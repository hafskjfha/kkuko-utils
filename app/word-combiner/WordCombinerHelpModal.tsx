...
const HelpModal: React.FC<HelpModalprop> = ({ onClose, wantGo }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50 ">
            <div ref={modalRef} className="bg-white rounded-lg p-6 w-96 overflow-y-auto md:w-2/3 lg:w-1/2 max-h-[80vh]">
                {/* Title */}
                <h3 className="text-lg font-bold mb-4">끄코 낱장 단어 조합기 사용설명서</h3>
                ...
                {/* 본문 */}
                <div>
                    <h3 ref={nomalHelp} className="text-xl font-semibold mb-2">
                        기본 이용법
                    </h3>
                    <div className="mb-4 flex flex-col items-center">
                        <div className="relative rounded-lg shadow-md mb-4" style={{ width: '100%', paddingTop: '56.25%' }}>
                            <Image
                                src="/nomal-help.png"
                                alt="nomal-help"
                    ...
                    <h3 ref={HTMLHelp} className='text-xl font-semibold mb-2'>
                        html입력창 이용법
                    </h3>

                    <h4 ref={chromeHTML} className='text-lg font-semibold mb-2'>
                        구글 크롬(chrome)
                    </h4>
                    <p className="mb-4">
