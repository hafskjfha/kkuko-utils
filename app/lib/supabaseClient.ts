...
import type { ProgressCallback, SupabaseResult, SupabaseArrayResult } from '@/types/supabase.types';
 ...
 *
 * @returns Promise<SupabaseArrayResult<T>> - 성공 시 모든 데이터를 합친 결과, 실패 시 에러 정보
 */
