...
const WordExtractorApp: React.FC = () => {
    ...
    const handleHelp = () => {
        window.open("https://docs.google.com/document/d/1vbo0Y_kUKhCh_FUCBbpu-5BMXLBOOpvgxiJ_Hirvrt4/edit?tab=t.0#heading=h.xj79r0jfcmii", "_blank", "noopener,noreferrer");
    }
